...
PYTHON="/Users/karl/.hermes/hermes-agent/venv/bin/python3"
...
if [ -n "$(git status --porcelain)" ]; then
    ...
    git add README.md photo.jpg state.json index.html local_analyze.py rotate.py rotate_and_push.sh analysis_report.json display_profiles.json crop_geometry.py qa_summary.md qa_source_preview.jpg
